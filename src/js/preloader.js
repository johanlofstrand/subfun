  ...
  Preloader.prototype = {
    ...
    loadResources: function () {
      //  this.load.spritesheet('subsheet', 'assets/sprites/subsheet.png',177,71);
        this.load.tilemap('map', 'assets/tilemaps/maps/submap.json', null, Phaser.Tilemap.TILED_JSON);
        ...
        this.load.atlasJSONArray('sprites', 'assets/sprites.png', 'assets/sprites.json');
        ...
        this.load.image('sb','assets/sb.png');
    },
